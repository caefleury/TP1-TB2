...
void Data::validar_dominio(const string data)
{
    ...
    string padrao_data = (bissexto ? "(0[1-9]|[1-2][0-9]|3[0-1])/(JAN|FEV|MAR|ABR|MAI|JUN|JUL|AGO|SET|OUT|NOV|DEZ)/2[0-9]{3}" : "(0[1-9]|[1-2][0-8]|3[0-1])/(JAN|FEV|MAR|ABR|MAI|JUN|JUL|AGO|SET|OUT|NOV|DEZ)/2[0-9]{3}");
